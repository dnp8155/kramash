...
// supabase/functions/clientViewQuotation/index.ts
  ...
  try {
    ...
    return Response.json({
      quotation: {
        ...
        template_id: q.template_id || "black_premium",
        template_config: q.template_config || "{}",
