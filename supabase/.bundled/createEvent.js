...
// supabase/functions/createEvent/index.ts
Deno.serve(withCors(async (req) => {
  try {
    ...
    const { data, error } = await supabaseAdmin.from("events").insert({ ...payload, workspace_id, public_token, public_tracking_enabled: true }).select("*").single();
