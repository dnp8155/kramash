...
Deno.serve(withCors(async (req) => {
  try {
    ...
    let milestones = [], bankDetails = null, socialLinks = null;
    milestones = safeJson(q.payment_schedule_json) || [];
    bankDetails = safeJson(q.bank_details_snapshot);
    socialLinks = safeJson(q.social_links_snapshot);
    ...
    return Response.json({
      quotation: {
        ...
        template_id: q.template_id || "black_premium", template_config: q.template_config || "{}",
        ...
        show_pricing: q.show_pricing !== false, hide_team_names: !!q.hide_team_names, terms_and_conditions: q.terms_and_conditions || "",
        special_notes: q.special_notes || "", payment_conditions: q.payment_conditions || "",
        footer_message: q.footer_message || "", visibility: safeJson(q.template_config)?.visibility || {},
