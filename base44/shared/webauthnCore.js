...
// Ported from supabase/functions/_shared/webauthnCore.ts.
// Uses base44:runtime secrets instead of Deno.env.
...
export async function createChallengeToken(challenge, userId) {
  ...
  const appKey = secrets.get("BASE44_APP_ID") || secrets.get("APP_SECRET") || "fallback-key";
