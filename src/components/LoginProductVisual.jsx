        ...
        <div className="flex h-[460px] xl:h-[500px]">
          ...
          <div className="flex-1 bg-background p-5 overflow-hidden">
            <div className="flex items-center justify-between mb-5">
              <div>
                <div className="text-[9px] text-muted-foreground uppercase tracking-wider font-semibold">Workspace</div>
            ...
            <div className="space-y-2">
              {projects.map((p, i) => (
                <div key={i} className="flex items-center gap-3 p-2.5 rounded-lg border border-border bg-card">
                  ...
                  <div className={`text-[9px] px-2 py-0.5 rounded-full font-medium whitespace-nowrap ${badgeClasses[p.tone]}`}>
                    {p.status}
                  </div>
                </div>
              ))}
