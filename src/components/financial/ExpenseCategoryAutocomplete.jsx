...
// Autocomplete/suggestion input for expense categories (misc expense mode).
// Mirrors the EventTypeAutocomplete UX from the event/project page:
// - Shows previously-used category names as suggestions on focus
// - Filters as the user types
// - Allows custom values (not in the suggestion list) via "Add new"
