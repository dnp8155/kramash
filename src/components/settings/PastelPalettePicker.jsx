...
// active. Lets the user manually pick ONE of 5 pastel colors as the app's accent color.
// No automatic assignment to event/work types — the user chooses the color themselves.
