          ...
          <div className="flex gap-2">
            <button type="button" onClick={() => !readOnly && setMode("day_wise")} disabled={readOnly}
              className={cn(
                ...
                mode === "day_wise" ? "border-primary bg-primary/10 text-foreground" : "border-border text-muted-foreground hover:bg-muted/40",
            ...
            <button type="button" onClick={() => !readOnly && setMode("regular")} disabled={readOnly}
              className={cn(
                "flex items-center gap-2 px-3 py-2 rounded-lg text-sm border transition-colors",
                mode === "regular" || !mode ? "border-primary bg-primary/10 text-foreground" : "border-border text-muted-foreground hover:bg-muted/40",
                !readOnly && "cursor-pointer"
              )}>
