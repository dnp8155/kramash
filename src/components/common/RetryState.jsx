...
/**
 * RetryState — shown when a page's data completely failed to load (no cached
 * data available). Renders a centered error card with an optional retry
 * button so the user is never left looking at a blank screen.
 */
