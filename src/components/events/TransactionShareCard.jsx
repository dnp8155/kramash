...
export default function TransactionShareCard({
  ...
  const sign = isOut ? "-" : "+";
  const logoUrl = showLogo && workspace?.logo ? workspace.logo : null;
  ...
  return (
    ...
    >
      {/* Centered logo watermark (Pro — Show Logo on Invoice) */}
      {logoUrl && (
        <img
          src={logoUrl}
          alt=""
      ...
      {/* Fields grid */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px 16px", position: "relative", zIndex: 1 }}>
        <div>
          <div
            style={{
              fontSize: "10px",
