...
// Bank & UPI + Social Links editing section for the Invoice Editor.
// These are saved as immutable snapshots on the invoice at save time.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="sm:col-span-2">
            ...
            <Input
              ...
              onChange={(e) => updateBank("upi_id", e.target.value)}
              disabled={readOnly}
