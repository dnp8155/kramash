      ...
      <AppDialogContent maxWidth="max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          <AppDialogBody className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input type="number" min="0" value={form.default_rate} onChange={(e) => set("default_rate", e.target.value)} placeholder="0" />
              </div>
              <div className="space-y-1.5">
          ...
          <AppDialogFooter>
            ...
            <Button type="submit" disabled={saving}>{saving ? "Saving…" : role ? "Save Changes" : "Add Role"}</Button>
          </AppDialogFooter>
        </form>
      </AppDialogContent>
    </AppDialog>
