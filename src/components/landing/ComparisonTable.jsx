...
export default function ComparisonTable() {
  return (
    <section className="py-20 sm:py-24 border-t border-[#E5E5E5]">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="rounded-2xl border border-[#E5E5E5] overflow-hidden">
          <div className="grid grid-cols-[1fr_auto_auto] bg-[#F9F9F9] border-b border-[#E5E5E5]">
            <div className="px-5 sm:px-6 py-4 text-xs font-semibold uppercase tracking-wider text-[#999]" />
            <div className="px-5 sm:px-8 py-4 text-xs font-semibold uppercase tracking-wider text-foreground text-center">
              Kramasha
            </div>
            <div className="px-5 sm:px-8 py-4 text-xs font-semibold uppercase tracking-wider text-[#999] text-center">
              Others
            </div>
          </div>
          {rows.map((row, i) => (
            ...
            >
              <div className="px-5 sm:px-6 py-4 text-sm text-foreground font-medium">{row}</div>
              <div className="px-5 sm:px-8 py-4 flex justify-center">
