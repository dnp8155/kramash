...
const faqs = [
  {
    q: "Is Kramasha only for photographers and event businesses?",
  ...
  },
  {
    ...
    a: "Yes. Kramasha automatically adapts its terminology based on your business category, so Architecture workspaces use Projects, Project Sites and Project Teams.",
  },
  {
    q: "Can I use Kramasha without GST?",
    a: "Yes. GST is optional. Non-GST businesses can use quotations and financial features normally.",
  },
  {
    q: "Does Kramasha support GST billing?",
    a: "Kramasha supports optional GST in quotations, including CGST/SGST and IGST modes. It does not handle statutory GST filing or compliance certification.",
  },
  {
  ...
  {
    q: "Is Kramasha a mobile app?",
    a: "Kramasha is a responsive web application with PWA support and can be installed on supported devices. It is not a native Android or iOS app.",
  },
];
