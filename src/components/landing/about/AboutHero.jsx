      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-20 pb-16 sm:pt-28 sm:pb-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-9 flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/register" className="h-12 px-6 inline-flex items-center justify-center gap-2 text-sm font-semibold bg-primary text-primary-foreground hover:bg-primary-hover rounded-xl shadow-md hover:shadow-lg transition-all">
              Start for free
              <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/" className="h-12 px-6 inline-flex items-center justify-center gap-2 text-sm font-semibold border border-border bg-card text-foreground hover:bg-muted rounded-xl shadow-sm transition-all">
              See the product
            </Link>
          </div>
        </div>
