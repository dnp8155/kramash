      ...
      <div className="relative overflow-hidden rounded-3xl bg-primary text-primary-foreground px-6 sm:px-12 py-14 sm:py-20 text-center shadow-xl">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/register" className="h-12 px-6 inline-flex items-center justify-center gap-2 text-sm font-semibold bg-primary-foreground text-primary hover:bg-primary-foreground/90 rounded-xl shadow-md transition-all">
              Start for free
              <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/faq" className="h-12 px-6 inline-flex items-center justify-center gap-2 text-sm font-semibold border border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 rounded-xl transition-all">
              Read the FAQ
            </Link>
          </div>
        </div>
