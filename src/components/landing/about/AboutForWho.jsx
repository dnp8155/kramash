...
const audience = [
  { icon: CalendarRange, title: "Event managers", body: "Juggling vendors, coordinators, and a dozen moving parts per event." },
  { icon: Camera, title: "Photographers & videographers", body: "Running crews across shoots, edits, and deliverables." },
  { icon: Compass, title: "Architects & interior teams", body: "Managing projects, consultants, and contractors." },
  { icon: Wand2, title: "Freelancers & small studios", body: "Makeup artists, decorators, editors, drone operators — track jobs and payments without an accountant." },
];
