...
import { User, FolderKanban, CalendarCheck, Users, Briefcase, FileText, Receipt, Wallet, BarChart3, ChevronRight, ArrowDown } from "lucide-react";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal className="max-w-2xl mb-14">
          ...
          <p className="text-[#8A8580] text-base sm:text-lg leading-relaxed">
            Kramashah keeps every step connected — from the first lead to the final financial report — instead of forcing you to maintain separate spreadsheets and apps.
          </p>
        </Reveal>
