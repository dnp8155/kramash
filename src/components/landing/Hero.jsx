...
export default function Hero() {
  const floatingCards = [
    { label: "REVENUE", value: "₹18.4L", sub: "+24%", icon: TrendingUp, className: "top-0 -left-4" },
    { label: "UPCOMING SHOOTS", value: "7", sub: "this week", icon: CalendarCheck, className: "top-8 -right-4" },
    { label: "OUTSTANDING", value: "₹2.1L", sub: "3 due", icon: Wallet, className: "bottom-8 -left-4" },
    { label: "ACTIVE LEADS", value: "42", sub: "+8 today", icon: Users, className: "bottom-0 -right-4" },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-[#0B2125] leading-[1.05] mb-5">
              ...
              <span className="text-[#F58220]">one workspace.</span>
            </h1>
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="w-7 h-7 rounded-lg bg-[#F58220]/10 flex items-center justify-center">
                    <card.icon className="w-3.5 h-3.5 text-[#F58220]" strokeWidth={1.75} />
                  </div>
