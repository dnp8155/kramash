        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <Reveal>
            ...
            <h2 className="font-heading text-3xl sm:text-4xl font-semibold tracking-tight text-white mb-4 leading-tight">
              Built for Photography Businesses.
            </h2>
            <p className="text-[#888] text-base leading-relaxed mb-6">
              Wedding packages, add-ons, team scheduling, client-facing quotations (without exposing internal costs), e-sign, invoices and job sheets — all connected.
            </p>
