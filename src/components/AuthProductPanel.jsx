      ...
      <div className="relative z-10 flex flex-col justify-between p-10 xl:p-14 text-sidebar-foreground w-full">
        ...
        <div className="max-w-md py-8">
          ...
          <p className="mt-4 text-sidebar-muted text-base leading-relaxed">
            From client details to projects, team assignments, quotations and payments — Kramashah keeps your workflow connected.
          </p>
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-sidebar-muted/60 pt-2">© {new Date().getFullYear()} Kramashah. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
