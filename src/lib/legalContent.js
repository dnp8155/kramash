...
These Terms of Service ("Terms") govern access to and use of Kramasha (the "Service", "App", "we", "us"), operated by Kramasha, having its registered office at **Lad Apartment, Vadodara, Gujarat** ("Company").
...
> **Note on Launch Timeline:** The Service will operate under a trial period from **19 September 2026 to 11 October 2026**, after which it will officially transition to public availability.
...
* **3.3.** You must notify us promptly at **kramashaofficial[at]gmail[dot]com** if you become aware of unauthorized access to your account.
...
* **5.4. Renewal:**
  ...
  * *If auto-renewing:* Pro subscriptions renew automatically at the end of each billing cycle unless cancelled at least **14 days** before the renewal date. You may cancel auto-renewal at any time from Your Plan in the App; cancellation takes effect at the end of the current billing period.

* **5.5. Refunds:** Fees are non-refundable except where required by law, or a short cooling-off period of **7 days** for first-time subscribers who have not materially used Pro features.
* **5.6. Downgrade & data retention:** If your Pro subscription lapses or is not renewed, your Workspace automatically reverts to the Free plan. Your Data already stored will not be deleted as a result of downgrade. Where your existing data exceeds Free-plan limits, that data remains stored and viewable but you may be restricted from creating new records or exporting beyond Free-plan limits until you upgrade again.
...
* **11.1.** You may stop using the Service and/or request account deletion at any time by contacting **kramashaofficial[at]gmail[dot]com**.
...
We work hard to keep Kramasha running smoothly, but software can occasionally experience unexpected issues or downtime. To the maximum extent permitted by law, Kramasha won't be responsible for indirect losses, lost profits, or data loss arising from your use of the Service.

If something does go wrong, our maximum financial liability to you for any claims will not exceed the total amount you paid us for your subscription in the 12 months leading up to the claim.
