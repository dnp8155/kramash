        ...
        {plans.map((p) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              {p.current && <span className="text-xs px-2 py-0.5 rounded bg-muted text-muted-foreground">Current</span>}
            </div>
            ...
            <Button variant={p.highlight ? "primary" : "outline"} className="mt-5" disabled={p.current}>
              {p.cta}
            </Button>
          </div>
        ))}
