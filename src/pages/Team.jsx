  ...
  return (
    <div className="p-4 sm:p-6 space-y-5">
      <PageHeader eyebrow="People" title="Team" subtitle="Manage your roster, roles, and availability.">
        <Button variant="outline" size="sm" onClick={() => { if (!checkFeature("excel_csv_export_enabled", "Excel Export")) return; exportTeamXlsx(filtered, rolesById); }} disabled={filtered.length === 0}>
