...
// Password-only client portal login.
// Reached via /client-login/:token — the client enters only a password
// (no email). On success a portal session is stored and they're sent to /client-portal.
export default function ClientPasswordLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await base44.functions.invoke("verifyClientPortalAccess", { token, password });
