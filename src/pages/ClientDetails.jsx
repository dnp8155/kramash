...
import { ArrowLeft, Pencil, Phone, Mail, MapPin, Calendar, ArrowRight, StickyNote, KeyRound } from "lucide-react";
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <button onClick={() => navigate("/clients")} className="-ml-2 inline-flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {client.portal_access_enabled ? "Manage Portal" : "Generate Password"}
          </Button>
