        ...
        <article className="prose-legal">
          <ReactMarkdown
            components={{
              ...
              table: ({ children }) => <div className="overflow-x-auto mb-4"><table className="w-full text-sm border border-border rounded-lg">{children}</table></div>,
              thead: ({ children }) => <thead className="bg-muted">{children}</thead>,
              th: ({ children }) => <th className="text-left font-semibold text-foreground px-3 py-2 border-b border-border">{children}</th>,
              td: ({ children }) => <td className="text-muted-foreground px-3 py-2 border-b border-border">{children}</td>,
            }}
          >
